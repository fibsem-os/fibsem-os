...
def main():
    ...
    parser = argparse.ArgumentParser(
        "Generate segmentation objects from segmentation labels"
    )
    parser.add_argument("--data_path", type=str, help="Path to data directory")
    parser.add_argument("--labels_path", type=str, help="Path to labels directory")
    parser.add_argument(
        "--dataset_json_path", type=str, default=None, help="Path to save dataset json"
    )
    parser.add_argument(
        "--min_pixels",
        type=int,
        default=100,
        help="Minimum number of pixels for an object to be considered",
    )
