...
from fibsem.milling.strategy import DEFAULT_STRATEGY_NAME, MILLING_STRATEGY_NAMES
...
class FibsemMillingWidget(FibsemMillingWidgetUI.Ui_Form, QtWidgets.QWidget):
    ...
    def update_current_selected_strategy(self):
        ...
        strategy = get_strategy(strategy_name, {"config": {}}) # TODO: default strategy configs
