...
class SEMAcquisitionWidget(QWidget):
    ...
    def acquire_image(self) -> None:
        ...
        try:
            ...
            if self.microscope.get_stage_orientation() not in ["FM", "SEM"]:  # NOTE: refactor once able to use at T=0
                QMessageBox.warning(self, "Orientation Error", "Please switch to FM or SEM orientation before acquiring an image.")
                return
