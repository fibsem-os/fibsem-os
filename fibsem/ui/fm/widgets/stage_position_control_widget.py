...
class StagePositionControlWidget(QWidget):
    ...
    def initUI(self):
        ...
        orientation_layout.addWidget(self.button_refresh_stage_position, 2, 0)
        ...
        # disable move to milling angle button (SAFETY)
        self.button_move_to_milling.setEnabled(False)
        self.milling_angle_spinbox.setEnabled(False)
        self.milling_angle_spinbox.setToolTip("Milling angle control is disabled in this mode.")
        self.button_move_to_milling.setToolTip("Milling angle control is disabled in this mode.")
