...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -269, 501, 1071))
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_image_dwell_time, 1, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.checkBox_image_drift_correction, 12, 0, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.checkBox_image_save_image, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.spinBox_image_frame_integration, 11, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.spinBox_image_scan_interlacing, 10, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboBox_image_resolution, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboBox_presets, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.checkBox_image_use_autogamma, 4, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.spinBox_image_line_integration, 8, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEdit_image_path, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_image_hfw, 2, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEdit_image_label, 7, 2, 1, 1)
        ...
        self.groupBox_beam.setEnabled(True)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.groupBox_beam.setFont(font)
        self.groupBox_beam.setFlat(False)
        self.groupBox_beam.setCheckable(False)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_stigmation_x, 6, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_shift, 7, 0, 1, 1)
        self.doubleSpinBox_shift_x = QtWidgets.QDoubleSpinBox(self.groupBox_beam)
        self.doubleSpinBox_shift_x.setSuffix("")
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_shift_x, 7, 1, 1, 1)
        self.label_beam_status = QtWidgets.QLabel(self.groupBox_beam)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.label_beam_status.setFont(font)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_stigmation_y, 6, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.spinBox_beam_scan_rotation, 8, 1, 1, 2)
        self.comboBox_beam_current = QtWidgets.QComboBox(self.groupBox_beam)
        self.comboBox_beam_current.setObjectName("comboBox_beam_current")
        self.gridLayout_4.addWidget(self.comboBox_beam_current, 3, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_beam_scan_rotation, 8, 0, 1, 1)
        self.doubleSpinBox_shift_y = QtWidgets.QDoubleSpinBox(self.groupBox_beam)
        self.doubleSpinBox_shift_y.setSuffix("")
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_shift_y, 7, 2, 1, 1)
        self.label_beam_voltage = QtWidgets.QLabel(self.groupBox_beam)
        self.label_beam_voltage.setObjectName("label_beam_voltage")
        self.gridLayout_4.addWidget(self.label_beam_voltage, 4, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_beam_voltage, 4, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.button_set_beam_settings, 9, 0, 1, 3)
        self.label_stigmation = QtWidgets.QLabel(self.groupBox_beam)
        self.label_stigmation.setObjectName("label_stigmation")
        self.gridLayout_4.addWidget(self.label_stigmation, 6, 0, 1, 1)
        ...
        self.comboBox_beam_voltage = QtWidgets.QComboBox(self.groupBox_beam)
        self.comboBox_beam_voltage.setObjectName("comboBox_beam_voltage")
        self.gridLayout_4.addWidget(self.comboBox_beam_voltage, 5, 1, 1, 2)
        ...
        self.checkBox_save_with_selected_lamella = QtWidgets.QCheckBox(Form)
        self.checkBox_save_with_selected_lamella.setObjectName("checkBox_save_with_selected_lamella")
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox_save_with_selected_lamella.setText(_translate("Form", "Save with Selected Lamella"))
