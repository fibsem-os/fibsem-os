...
def get_column_tilt(manufacturer: str, beam: str) -> int:
    ...
    manufacturer = manufacturers.normalize_manufacturer(manufacturer)
...
def get_user_config() -> dict:
    ...
    # enter manufacturer
    manufacturer = input("Enter microscope manufacturer (ThermoFisher, Tescan, Demo): ")
    manufacturer = manufacturers.normalize_manufacturer(manufacturer)
    assert manufacturer in DEFAULT_CONFIGURATION_VALUES, (
        "Unknown manufacturer. Must be ThermoFisher, Tescan or Demo"
    )
