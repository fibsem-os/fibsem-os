...
for name, train_path, test_path in zip(
    autolamella_datasets.keys(), train_paths, test_paths
):
...
waffle_dataset.push_to_hub(
    "patrickcleeve/autolamella", config_name="waffle", private=True
)
liftout_dataset.push_to_hub(
    "patrickcleeve/autolamella", config_name="liftout", private=True
)
serial_liftout_dataset.push_to_hub(
    "patrickcleeve/autolamella", config_name="serial-liftout", private=True
)
