...
class AutoLamellaUI(QMainWindow):
    ...
    def setup_hooks(self) -> HookManager:
        ...
        # something wants a machine-readable per-lamella record. It needs
        # write_completion_summary from tools.artifacts; FunctionHook and HookEvent are
        # already imported, for the map below.
        #
